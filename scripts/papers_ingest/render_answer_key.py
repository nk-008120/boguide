"""
Renders one or more PDF pages at high DPI so a human or a free vision model
can transcribe the official answer key — replaces Claude spending vision
tokens reading it directly (see context/papers-ingestion-lean-workflow.md,
stage 2).
...
from pdf_tools import open_pdf, render_page_region  # noqa: E402
