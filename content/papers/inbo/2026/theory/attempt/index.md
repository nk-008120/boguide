...
<section id="attempt-start" class="attempt-screen">
  <h2>Timed Attempt - Theory</h2>
  <p>58 questions (Q8 was officially deleted) · 120 minutes. Mixed format (multiple-choice, true/false, and numeric questions).</p>
...
{{< papers-attempt olympiad="inbo" year="2026" round="theory" >}}
