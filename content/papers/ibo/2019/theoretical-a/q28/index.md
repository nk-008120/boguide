...
The human genome is composed of about 3×10⁹ base pairs. Assume that the distribution of base pairs is random. How long should a random sequence be to appear once in the human genome, on average?

{{< papers-quiz olympiad="ibo" year="2019" round="theoretical-a" problem="q28" >}}

{{< papers-problem-nav olympiad="ibo" year="2019" round="theoretical-a" problem="q28" >}}
