---
title: "Q57 — PIP2/PIP3 Signaling in T Cells — PTEN and Antigen Dose"
---
...
![Figure. Left plot: experimentally measured PIP2 concentration vs time. Right plot: PIP3 concentration vs time. Blue = low dosage stimulation, red = high dosage. Solid lines = no SF1670; dotted lines = SF1670 (PTEN inhibited) used.](/papers/ibo/2022/q57-figure-1.png)
*Figure. PIP2 (left) and PIP3 (right) concentration over time under four experimental conditions.*

Determine whether the following statement are true or false:

{{< papers-quiz olympiad="ibo" year="2022" round="theoretical-2" problem="q7" >}}

{{< papers-problem-nav olympiad="ibo" year="2022" round="theoretical-2" problem="q7" >}}

---

Question reproduced from **IBO 2022, Theoretical Paper 2**, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) — attributed to the International Biology Olympiad. [Open the full exam PDF](/papers/ibo/2022/theoretical-2-exam.pdf#page=12) · [Community solutions (unofficial)](/papers/ibo/2022/theoretical-2-solutions.pdf)
