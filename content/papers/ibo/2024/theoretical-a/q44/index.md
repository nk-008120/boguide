...
![Bar charts comparing sperm straight-line velocity with and without R848 across glucose concentrations, the distribution of X- and Y-bearing sperm in the upper layer after R848 treatment, and the sex ratio of embryos from IVF using untreated versus upper- and lower-layer sperm.](/papers/ibo/2024/q44-figure-2.png)
*Figure 2. A Comparison of straight-line velocity (VSL) of spermatozoa in different glucose concentrations (mM) without (C) and with (R) R848. '*' - significant difference between C and R. B Distribution of X chromosome- and Y chromosome-bearing spermatozoa in the upper layer without (Ct.) and with R848. C Comparison of sex of the embryos obtained from IVF with untreated sperm cells (Ct.) in contrast to sperm cells from the upper (U) and lower (L) layers of the swim-up test tube separated after treatment with R848.*

On your answer sheet, indicate "T" for true statements and "F" for false ones.

{{< papers-quiz olympiad="ibo" year="2024" round="theoretical-a" problem="q44" >}}

{{< papers-problem-nav olympiad="ibo" year="2024" round="theoretical-a" problem="q44" >}}
