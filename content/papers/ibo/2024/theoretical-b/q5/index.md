---
title: "Q5 - Ketogenic Diet Metabolism and Catecholamine Seizure Latency"
---
...
![A metabolic pathway diagram connecting glycolysis, ketolysis, the TCA cycle, and the glutamate/GABA shunt, with three numbered reaction steps circled.](/papers/ibo/2024/theoretical-b/q5-figure-1.png)
...
![Left: a pathway from tyrosine through L-DOPA, dopamine, noradrenaline (via DBH), and adrenaline (via PNMT). Right: a bar chart of seizure latency threshold for Dbh+/- and Dbh-/- mice on normal vs. ketogenic diet, with the ketogenic diet only raising the threshold significantly in Dbh+/- mice.](/papers/ibo/2024/theoretical-b/q5-figure-2.png)
...
{{< papers-quiz olympiad="ibo" year="2024" round="theoretical-b" problem="q5" >}}

{{< papers-problem-nav olympiad="ibo" year="2024" round="theoretical-b" problem="q5" >}}

---

Question reproduced from **IBO 2024, Theoretical Exam Part B**, licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) - attributed to the International Biology Olympiad. [Open the full exam PDF](/papers/ibo/2024/theoretical-b-exam.pdf#page=10)
