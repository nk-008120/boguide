...
![Two-panel figure: panel A shows four flow-cytometry dot plots (unmodified RNA, m5C, pseudouridine (Ψ), and s2U) plotting CD83 against MHC-II expression in dendritic cells, each with the percentage of cells above and below an activation threshold; panel B is a bar chart of fold-increase in translation for mRNA with different nucleotide modifications (unmodified, Ψ, m5U, s2U, m5C, m6A, and 5%-m6A).](/papers/ibo/2024/theoretical-b/q48-figure-1.png)
*Figure 1. A Activatory response of antigen-presenting dendritic cells to specific RNA nucleotide modifications, recorded as cell-surface receptor levels (UN: unmodified). Each dot represents a single dendritic cell; above the threshold, dendritic cells are activated, expressing higher levels of both CD83 and MHC-II. B Efficiency of modified mRNAs' translation by cells (UN: unmodified).*

On your answer sheet, indicate "T" for true statements and "F" for false ones.

{{< papers-quiz olympiad="ibo" year="2024" round="theoretical-b" problem="q48" >}}

{{< papers-problem-nav olympiad="ibo" year="2024" round="theoretical-b" problem="q48" >}}
