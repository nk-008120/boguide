...
<div id="bioclash-attempt-root" class="bioclash-page bioclash-case-file" data-paper-id="bioclash-sample">
  ...
  <section id="bioclash-attempt-start">
    ...
    If this happens, reload the page in this same tab immediately to recover. Repeated or
    prolonged interruptions could jeopardize your ability to complete the paper.</p>
    <div class="bioclash-attempt-directives">
      <h2>Before you start - check each box to confirm you understand</h2>
  ...
  <section id="bioclash-attempt-report" hidden></section>
</div>

<script src="/js/bioclash-attempt.js" defer></script>