...
![Asconoid, syconoid, and leuconoid sponge body plans compared, with a shared legend for choanocytes, mesohyl, pinacocytes, and water flow direction; osculum and dermal pores labeled.](sponge-asconoid-syconoid-leuconoid-body-plans.jpg)
*Source: ThoughtCo*
...
![Polyp form (tentacles, mouth, ectoderm, mesoglea, endoderm, gastrovascular cavity all labeled) and medusa form (mouth, tentacles), connected by a life-cycle arrow showing the transition between the two.](cnidarian-polyp-vs-medusa-body-forms.jpg)
...
![A cnidocyte in three stages: coiled at rest (cnidocil trigger, hinged operculum visible), mid-firing (barbed threads partially everted), and fully fired (capsule, barbs, and thread fully extended from the tentacle).](cnidocyte-nematocyst-before-after-firing.jpg)
...
![A flame cell with its nucleus and beating cilia projecting into the tubule lumen, connected to a downstream tube cell.](flatworm-protonephridium-flame-cell.jpg)
...
![Tapeworm scolex labeled with the rostellum, hooks, and suckers, with the neck giving rise to a chain of proglottids progressing from immature to mature to gravid.](tapeworm-scolex-proglottid-chain.jpg)
...
![Nematode cross-section labeling the cuticle, hypodermis, body muscle, pseudocoelom, dorsal/ventral/lateral chords, nerves, intestinal epithelium and lumen, and (in this female specimen) the ovary, oviduct, eggs, uterus, and excretory duct.](nematode-cross-section-cuticle-pseudocoelom-muscle.webp)
*Source: ResearchGate*
...
![Phylum Annelida class comparison: Oligochaeta (earthworm), "Polychaeta," and Hirudinea (leech) shown side by side.](annelid-class-comparison-polychaete-oligochaete-leech.webp)
