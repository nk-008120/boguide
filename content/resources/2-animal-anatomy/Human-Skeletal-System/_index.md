...
Bone is never metabolically static: osteoblast-driven deposition and osteoclast-driven resorption occur continuously and are normally balanced, allowing bone to adapt its internal trabecular architecture to mechanical load (denser trabeculae along lines of stress) and to serve as the body's principal calcium reservoir. **Parathyroid hormone (PTH)**, released when blood calcium falls, stimulates osteoclast activity (indirectly, via signaling to osteoblasts, which in turn promote osteoclast differentiation), releasing calcium into the blood; **calcitonin** opposes this, favoring calcium deposition into bone when blood calcium is high. This hormonal axis is a standard cross-reference point linking skeletal anatomy to endocrine physiology on IBO papers.
