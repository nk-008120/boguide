...
![Kidney gross anatomy in coronal section: fibrous capsule, renal cortex, renal medulla, renal pyramids, renal columns, renal papilla, minor and major calyces, renal pelvis, hilum, renal artery/vein, and ureter, with a whole-body inset showing kidney position.](kidney-gross-anatomy-cortex-medulla-pyramids.png)
...
![Cortical nephron (short loop of Henle) vs. juxtamedullary nephron (long loop reaching deep into the medulla, near the papilla) compared, alongside a PO2 gradient bar showing oxygen tension falling from 70 mmHg in the cortex to 10 mmHg near the papilla.](cortical-vs-juxtamedullary-nephron-comparison.webp)
...
![Transitional epithelium histology compared between a collapsed (relaxed) and a distended (stretched) urinary bladder wall, each shown as both a real micrograph and a labeled line diagram, cell layers appear taller/more numerous when collapsed and flattened/fewer when stretched.](transitional-epithelium-bladder-relaxed-stretched.jpg)
