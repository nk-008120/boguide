...
(function(){
  ...
  var diagrams = {
    ...
    human: {
      ...
      explain: 'Four chambers, two fully separated circuits: the right heart pumps only deoxygenated blood to the lungs, the left heart pumps only oxygenated blood to the body. No mixing occurs at any point. This is the structural endpoint of the fish → amphibian → human progression shown by this widget.'
    }
  };
