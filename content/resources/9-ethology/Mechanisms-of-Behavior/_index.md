...
- Tinbergen's four-questions diagram, one gull-chick-begging example filled into all four quadrants
- Stickleback red-belly attack diagram showing the realistic non-red model being ignored vs. the crude red model being attacked
- Greylag goose egg-rolling motion sequence, frame by frame
- Oystercatcher supernormal stimulus diagram: bird choosing an oversized egg over its own natural clutch
- Diagram of the psychohydraulic model (historical, framed as a qualitative teaching analogy rather than current mechanism)

<!-- VIDEO: Tinbergen's stickleback red-belly attack experiment recreation — Gasterosteus aculeatus — shows the swimming approach-and-attack behavior toward the crude red model, which is more convincing in motion than a still image -->
