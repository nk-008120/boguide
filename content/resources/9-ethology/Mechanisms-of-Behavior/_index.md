...
![The four-questions framework arranged as a 2×2 grid: Development and Causation/Mechanism as the two proximate ("how?") questions, Evolutionary History and Function/Survival Value as the two ultimate ("why?") questions, with a historical-sequence vs. slice-in-time axis distinguishing the pairs.](tinbergens-four-questions-gull-chick-example.png)
...
![Diagram of the greylag goose egg-rolling head-movement cycle, labeled with its three phase transitions (oblique, transition, forward) and the observed transition frequencies between them from Lorenz's original motion analysis.](greylag-goose-egg-rolling-fap-sequence.jpg)
...
![Tinbergen's stickleback model diagram: a highly realistic fish model with no red belly (top) was ignored, while four crude, non-fish-shaped models with red-painted undersides (bracketed "Models with red bellies") were attacked.](stickleback-red-belly-sign-stimulus-attack.jpg)
...
![Lorenz's psychohydraulic model diagram: a "drive" reservoir feeds through a spring-loaded release-mechanism valve into a set of "behavior" spouts, with an external "stimulus" weight on a pulley able to open the valve directly.](psychohydraulic-model-diagram.png)
