...
![Slide stating Hamilton's rule (rb > c), defining r as relatedness of donor to recipient, b as benefit to recipient, c as cost to donor, equivalent forms r > c/b and rb − c > 0, and noting that increased relatedness increases altruistic behavior while decreased relatedness increases "spitefulness."](hamiltons-rule-worked-example.webp)
*Source: SlideShare*
