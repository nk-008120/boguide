...
<!-- VIDEO: Honeybee waggle dance on the vertical comb face — Apis mellifera — the dance angle encoding direction relative to the sun only makes sense as motion against the hive's vertical surface, not as a still frame -->
...
- Waggle dance figure-eight diagram with angle-to-direction and duration-to-distance legends
- Peacock train diagram annotated with handicap-principle cost/honesty logic
- *Photuris*/*Photinus* firefly flash-pattern mimicry diagram comparing genuine *Photinus* female flashes to mimicked ones
- Ritualization sequence diagram: ancestral intention movement → exaggerated/stereotyped ritualized display, side by side
- Modality comparison chart (range/persistence/line-of-sight table above, as a graphic)

<!-- VIDEO: Vervet monkey alarm call playback experiment — Chlorocebus pygerythrus — showing the three distinct escape responses (climb, look up, look down) triggered by the three call types with no predator present, which is the entire evidentiary point of the study -->
