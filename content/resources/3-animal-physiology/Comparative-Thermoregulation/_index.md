...
![A dog illustrating all four heat-exchange modes at once: radiation (heat radiating outward from the body surface), evaporation (panting, tongue out), convection (heat stripped away by air currents around the body), and conduction (heat transfer to the ground through the paws)](heat-exchange-four-modes.webp)
*Source: Shutterstock*
...
![Core body temperature and metabolic rate plotted continuously across roughly a month of hibernation: both traces drop to a low, stable plateau during torpor bouts (temperature near 4°C, minimal O2 consumption), interrupted by sharp, brief spikes back to normal euthermic levels ("interbout euthermia") before returning to torpor, a repeating pattern rather than one continuous dormant state](hibernation-body-temperature-trace.webp)
*Source: ResearchGate, fig. 1*
