...
*Source: ResearchGate, fig. 3 — precise spec match, showing both the abstract geometric relationship and real comparative animal data across body sizes. Journal figure, open-access status not confirmed. Revisit before public deployment.*
...
*Source: bioRxiv, preprint 2021.05.08.443257 — exceeds spec with a full biomechanical model (force/power/work-loop/slope panels) rather than a single simplified stride diagram. Preprint server; confirm final publication/license status before public deployment.*
