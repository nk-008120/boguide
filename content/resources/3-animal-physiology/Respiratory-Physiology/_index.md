...
- O₂-hemoglobin dissociation curve at rest vs. shifted right (Bohr effect), with PO₂ values for lung capillary and active tissue marked
- CO₂ transport pathway diagram: dissolved CO₂, carbaminohemoglobin, and the bicarbonate/chloride-shift pathway, proportions labeled
- Central chemoreceptor mechanism: blood CO₂ crossing the blood-brain barrier, hydration to H⁺, CSF pH change, medullary response
- Peripheral chemoreceptor (carotid/aortic body) location diagram relative to major vessels
- Bicarbonate buffer equilibrium diagram showing the respiratory (ventilation rate) and renal (see [Homeostasis & Osmoregulation](../homeostasis-osmoregulation/)) control points on the same equation
