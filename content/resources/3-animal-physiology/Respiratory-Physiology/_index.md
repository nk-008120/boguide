...
*Source: **© PhysiologyWeb (physiologyweb.com)** — explicit copyright notice visible in the image itself. This is a confirmed commercial copyright, not merely an unconfirmed license — must not go on the public site without a license or replacement. Precise spec match otherwise.*
...
*Source: HMP Global Learning Network (EMS World) — precise spec match, plus the bonus left-shift factors (2,3-DPG, CO) beyond what the text discusses.*
...
*Source: GeeksforGeeks — focuses specifically on the dominant bicarbonate/chloride-shift pathway at both capillary beds; does not separately depict the dissolved-CO2 or carbaminohemoglobin forms or their relative proportions.*
...
*Source: ResearchGate / The Journal of Physiology, fig. 2 — a more specialized, research-level circuit diagram than a basic overview; uses RTN rather than explicitly showing the CSF-pH mechanism described in the text, and doesn't separately label the carotid/aortic bodies as "peripheral" or the RTN as "central" by name. Journal figure, open-access status not confirmed. Revisit before public deployment.*
...
*Source: ditki.com (Davenport diagram teaching module) — a more advanced clinical acid-base classification tool built on the same underlying bicarbonate equilibrium, rather than a direct diagram of the CO2+H2O⇌H2CO3⇌H++HCO3- equation with ventilation/renal control points labeled; captioned to flag this substitution.*
