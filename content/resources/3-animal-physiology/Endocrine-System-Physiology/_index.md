...
- Steroid/thyroid hormone mechanism diagram (membrane crossing, intracellular receptor, DNA binding, transcription)
- Peptide/amine hormone mechanism diagram (surface receptor, G-protein, adenylyl cyclase, cAMP, protein kinase A)
- Generic hypothalamic-pituitary-peripheral-gland hierarchy with the negative feedback loop arrows shown explicitly (paired with the Mermaid diagram above)
- Adrenal gland cross-section distinguishing cortex (zones: glomerulosa/fasciculata/reticularis) from medulla, with each region's hormone(s) labeled
- Insulin/glucagon antagonistic pair diagram showing opposite effects on blood glucose, liver glycogen, and peripheral tissue uptake
