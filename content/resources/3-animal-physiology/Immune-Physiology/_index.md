...
- Innate vs. adaptive immunity comparison diagram (paired with the table above)
- Phagocytosis sequence: pathogen recognition, engulfment, phagolysosome fusion, destruction
- Complement cascade schematic showing the three initiating pathways converging on opsonization, membrane attack complex, and inflammation recruitment
- Antibody (immunoglobulin) structure diagram: variable/constant regions, two antigen-binding sites
- MHC class I vs. class II antigen presentation, side by side, showing which cell types display each and which T cell subset responds to each
- Clonal selection diagram: single antigen-specific B cell proliferating into plasma cells and memory cells
