...
![Hypersensitive response: a leaf showing multiple discrete necrotic lesions, each a ring of dead tissue localized around and containing an infection site](hypersensitive-response.jpg)
*Source: Wikipedia*
...
![Systemic acquired resistance signaling downstream of R-gene-mediated resistance: salicylic acid triggers induction of PR-proteins (resistance to fungi and bacteria), increased RdRP expression (increased viral RNA turnover), and AOX-dependent expression of other defense genes (inhibition of viral replication and movement)](systemic-acquired-resistance.jpg)
