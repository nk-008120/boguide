...
*Source: ResearchGate, fig. 1, "The formation of the Isthmus of Panama split an ocean into two, creating a natural [experiment]" — note: the source figure's other panels (A/B) additionally document host-microbiome divergence across the isthmus, a research angle beyond this page's scope; only the geminate-species-pairs panel (C) is the relevant match here*
