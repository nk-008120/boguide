...
![Geologic timescale with the "big five" mass extinctions (Ordovician, Devonian, Permian, Triassic, K-T) marked alongside their estimated death rates, the same reference timeline introduced in History of Life & Major Transitions, reused here for its mass-extinction detail](geologic-timescale-milestones.jpg)
