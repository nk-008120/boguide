---
title: "Flower Anatomy & Reproductive Structures"
weight: 8
description: "The four floral whorls and complete/incomplete, perfect/imperfect flower terminology, anther structure and microsporogenesis producing the pollen grain male gametophyte, ovule structure and megasporogenesis producing the embryo sac female gametophyte, placentation types, and double fertilization."
difficulty: "advanced"
prerequisites: ["Plant-Tissue-Systems"]
...
The flower is a modified shoot whose leaves have differentiated into reproductive structures. Most of its terminology (whorl, merosity) already appeared in [Monocot vs Dicot Comparative Anatomy](../monocot-dicot-comparative-anatomy/) at the level of counting parts; this page goes inside each whorl to the cellular and developmental structure that actually produces the male and female gametophytes.
...
![Flower whorl diagram: 1st whorl (sepals), 2nd whorl (petals), 3rd whorl (stamens), 4th whorl (carpels), labeled in sequence from outermost to innermost.](complete-flower-longitudinal-section.webp)
...
![Anther structure and development: (a) diagram of the four pollen sacs (microsporangia) with tapetum and microspore mother cells labeled, developing into pollen-grain-filled sacs; (b) scanning electron micrographs of real anthers.](anther-cross-section-pollen-sacs.jpg)
...
![Full pollen development sequence: pollen mother cells → tetrads (meiosis I/II) → free microspores → bicellular pollen grain (exine/intine, vacuole, generative cell, vegetative nucleus) → mature tricellular pollen grain (sperm cells, vegetative nucleus, pore) → germinating pollen grain with pollen tube.](mature-pollen-grain-structure.webp)
...
![Ovule anatomy: embryo sac, chalaza, nucellus, antipodal cells, polar nuclei, central cell, synergid, egg cells, inner/outer integument, micropyle, hilum, funicle, raphe, and vascular strand all labeled.](ovule-longitudinal-section.jpg)
...
![Polygonum-type embryo sac: filiform apparatus, synergids, vacuole, oosphere (egg cell), polar nuclei, central cell, embryo sac membrane, and three antipodal cells, labeled from the micropylar to the chalazal end.](polygonum-embryo-sac.jpg)
...
1. A flower has sepals and stamens but no petals or carpels. Classify it as complete/incomplete and as perfect/imperfect.
2. Explain why three of the four megaspores produced by meiosis degenerate, while all four microspores from an equivalent meiotic division survive.
3. Name the two cells within a mature pollen grain and state the fate of each after the pollen tube reaches the embryo sac.
4. Explain why the primary endosperm nucleus is triploid while the zygote is diploid, tracing both back to the same pollen tube's sperm delivery.
5. A cross-section shows ovules attached along a central axis in an ovary with several internal septa. Identify the placentation type.
