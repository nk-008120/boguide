---
title: "Plant Body Plans Across Major Lineages"
weight: 10
description: "Structural comparison of bryophytes, seedless vascular plants (pteridophytes), gymnosperms, and angiosperms, vascular tissue presence and type, true root/stem/leaf organs, and the progressive structural reduction of the gametophyte across the alternation of generations that unifies all four lineages."
difficulty: "advanced"
prerequisites: ["Plant-Tissue-Systems", "Xylem-Phloem-Vascular-Tissue"]
...
![Fern life cycle: sori/sporangium on the underside of a leaflet, germinating spore, immature and mature prothallus (with archegonia, antheridia, rhizoids), sperm fertilizing an egg, developing sporophyte, and the mature sporophyte with rhizome and roots.](fern-life-cycle.jpg)
...
![Gymnosperm (pine) life cycle: mature sporophyte, male cone with spore sacs, female cone/ovules, meiosis producing male gametophytes (pollen grains) and a surviving spore, mitosis to female gametophyte, fertilization, and the resulting seed with food reserves and embryo.](gymnosperm-life-cycle.jpg)
*Source:*
...
![Angiosperm life cycle: flower structure (stigma/style/ovary, perianth, filament), meiosis in the microsporangium (anther) producing pollen and in the ovule producing the embryo sac (megagametophyte, with polar nuclei/antipodal/egg/synergid), pollination and fertilization via the pollen tube, and the resulting germinating seed (seed coat, endosperm, embryo).](angiosperm-life-cycle.jpg)
...
1. Explain why a moss cannot grow to tree height, referencing specifically what structural feature it lacks that a fern possesses.
2. Order the four lineages from largest to smallest female gametophyte, and explain the structural trend this ordering reflects.
3. A plant produces cones with naked seeds and lacks vessel elements. Identify the lineage and name one vascular-tissue and one reproductive-structure feature that distinguish it from an angiosperm.
4. Explain why fertilization in ferns still requires liquid water despite ferns having true vascular tissue and true roots/stems/leaves.
5. Explain why the angiosperm female gametophyte, at as few as seven cells, is still capable of producing both a zygote and a nutritive endosperm tissue from a single fertilization event.
