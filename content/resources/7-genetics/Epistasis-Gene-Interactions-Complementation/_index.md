...
- *(built later — see project workflow)* An epistasis ratio explorer: choose an interaction type (recessive/dominant/duplicate epistasis, duplicate genes) and see the 16-box dihybrid grid recolor to show which classes merge and the resulting simplified ratio.

**Static**

- Labrador coat color recessive epistasis diagram showing the B/E gene interaction and resulting 9:3:4 ratio
- Summer squash dominant epistasis diagram showing the W/Y gene interaction and resulting 12:3:1 ratio
- Pigment-pathway diagram for duplicate recessive epistasis (9:7), showing two sequential enzymatic steps each requiring a dominant allele
- Complementation test diagram: two mutant strains crossed, showing the complementing (wild-type F1) vs. non-complementing (mutant F1) outcomes side by side
