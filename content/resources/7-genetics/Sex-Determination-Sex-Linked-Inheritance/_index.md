...
- Reciprocal-cross questions (does it matter which parent carries the trait?) are a direct test of whether a student recognizes X-linkage — for autosomal genes reciprocal crosses are always equivalent, so any asymmetry is diagnostic.
