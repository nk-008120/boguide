...
- *(built later — see project workflow)* An incomplete-dominance-vs-codominance-vs-complete-dominance comparator: pick a dominance mode and a cross, and see the resulting phenotype ratio and a visual representation of the heterozygote's actual appearance.

**Static**

- Incomplete dominance diagram: red × white snapdragon cross showing pink F1 and the 1:2:1 phenotype ratio in F2
- Codominance diagram: MN blood group heterozygote showing both antigens present simultaneously on the cell surface
- ABO blood group genotype-to-phenotype mapping table (as above) as a standalone reference graphic
- Lethal-allele cross diagram: yellow mouse coat color cross showing the missing A^Y A^Y class and resulting 2:1 ratio
- Penetrance/expressivity diagram: a pedigree showing an apparently skipped generation due to reduced penetrance, contrasted with a fully penetrant pedigree
