...
- *(built later — see project workflow, paired with Translation & the Genetic Code's widget to form the coupled transcription/translation animation explicitly requested by Genetics' own placeholder unit)* A co-transcriptional processing animator: RNA Pol II moving along a gene, with the 5′ cap appearing immediately after initiation, splicing removing an intron mid-transcription, and the poly(A) tail added after cleavage at the transcript's 3′ end.

**Static**

- Prokaryotic vs. eukaryotic RNA polymerase/promoter-recognition comparison diagram
- Pre-mRNA processing diagram showing intron/exon structure before and after splicing
- Mature mRNA diagram showing 5′ cap, coding sequence, and poly(A) tail, with cap-binding/poly(A)-binding protein-mediated circularisation illustrated
