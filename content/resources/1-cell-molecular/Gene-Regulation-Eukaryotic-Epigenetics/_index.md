...
![miRNA/RISC mechanism: a target gene is transcribed into target mRNA in the nucleus; in the cytoplasm, an endogenous miRNA (hairpin structure) is loaded into an Argonaute (AGO) protein, base-pairs with the target mRNA, and the resulting miRNA-RISC complex causes translational repression and mRNA degradation](mirna-risc-mechanism.png)
