...
![Size-exclusion chromatography schematic: a mixed sample of large, medium, and small molecules enters a column packed with porous beads; large molecules bypass the pores and elute first, medium molecules partially enter pores and elute next, small molecules enter the most pores and elute last](size-exclusion-chromatography.webp)
