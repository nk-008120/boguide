...
- *(built later — see project workflow)* An α vs. β glycosidic bond builder: click two monosaccharide ring diagrams together in either configuration and see the resulting chain shape (helical vs. extended) render automatically — makes the single-cause structural argument of this page directly visible.

**Static**

- Open-chain vs. cyclic (pyranose) glucose structure, with the anomeric carbon and α/β configuration labelled
- Side-by-side amylose (helical) vs. cellulose (extended, sheet-forming) chain diagram
- Glycogen branching diagram showing α(1→4) backbone and α(1→6) branch points
