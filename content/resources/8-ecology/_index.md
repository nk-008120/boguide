...
## What does olympiad Ecology test?
    ...
    (function() {
        ...
        function initializeChart() {
            if (typeof Plotly === 'undefined') {
                // If Plotly isn't ready, try again in 100ms
                setTimeout(initializeChart, 100);
                return;
            }
            // --- Your original, unmodified chart code goes here ---
            // ... (the entire code block from your page)
            // --- End of your chart code ---
        }
...
**Worked example:** A bacterial population starts at $N_0 = 500$ cells with $r = 0.35\ \text{hr}^{-1}$. How many cells after 4 hours?
...
Same species richness; B is far more diverse because it is more even. Questions frequently ask you to calculate and compare these indices.
...
<span class="badge-custom">Important</span> Globally, **the open ocean covers ~70% of Earth's surface** but its low per-area productivity means the total ocean contribution to global NPP (~50 Pg C yr⁻¹) is less than the much smaller area of tropical forests. Questions often test whether students understand area vs. rate vs. total contribution.
...
**Application (conservation):** Habitat fragments behave like islands. Predictions:
...
Questions are ordered from recall to synthesis, matching olympiad difficulty progression. Click each answer link after attempting the question.
